	...
	}{
		{
			...
			exp: &ShowModuleResponse{InsAPI: struct {
				...
				{RowModdiaginfo: []struct {
					...
					{Diagstatus: "Pass", Mod: 1},

					{Diagstatus: "Pass", Mod: 2},

					{Diagstatus: "Pass", Mod: 3},

					{Diagstatus: "Pass", Mod: 4},

					{Diagstatus: "Pass", Mod: 22},

					{Diagstatus: "Pass", Mod: 24},

					{Diagstatus: "Pass", Mod: 26},

					{Diagstatus: "Pass", Mod: 27},

					{Diagstatus: "Fail", Mod: 29},
				...
				{RowModinfo: []struct {
					...
					{Model: "N9K-X9732C-EX", Modinf: 1, Modtype: "32x100G Ethernet Module", Ports: 32, Status: "ok"},

					{Model: "N9K-X9732C-EXM", Modinf: 2, Modtype: "32x100G Ethernet Module", Ports: 32, Status: "ok"},

					{Model: "N9K-X9788TC-FX", Modinf: 3, Modtype: "48x10G + 4x40/100G Ethernet Module", Ports: 52, Status: "ok"},

					{Model: "N9K-X9736C-FX", Modinf: 4, Modtype: "36x40/100G Ethernet Module", Ports: 36, Status: "ok"},

					{Model: "N9K-C9508-FM-E", Modinf: 22, Modtype: "8-slot Fabric Module", Ports: 0, Status: "ok"},

					{Model: "N9K-C9508-FM-E", Modinf: 23, Modtype: "8-slot Fabric Module", Ports: 0, Status: "powered-dn"},

					{Model: "N9K-C9508-FM-E", Modinf: 24, Modtype: "8-slot Fabric Module", Ports: 0, Status: "ok"},

					{Model: "N9K-C9508-FM-E", Modinf: 26, Modtype: "8-slot Fabric Module", Ports: 0, Status: "ok"},

					{Model: "N9K-SUP-A", Modinf: 27, Modtype: "Supervisor Module", Ports: 0, Status: "active *"},

					{Model: "N9K-SC-A", Modinf: 29, Modtype: "System Controller", Ports: 0, Status: "standby"},
				...
				{RowModmacinfo: []struct {
					...
					{Mac: " 00-a2-ee-31-b2-b4 to 00-a2-ee-31-b3-37  ", Modmac: 1, Serialnum: "SAL2039VA2U"},

					{Mac: " 00-6b-f1-bf-0d-f0 to 00-6b-f1-bf-0e-73  ", Modmac: 2, Serialnum: "FOC20444YD2"},

					{Mac: " a0-23-9f-0c-8f-28 to a0-23-9f-0c-8f-6b  ", Modmac: 3, Serialnum: "FOC21240U8B"},

					{Mac: " 2c-d0-2d-3e-a5-08 to 2c-d0-2d-3e-a5-9b  ", Modmac: 4, Serialnum: "FOC210707HG"},

					{Mac: " NA ", Modmac: 22, Serialnum: "SAL2035URFY"},

					{Mac: " NA ", Modmac: 23, Serialnum: "SAL2035UUN3"},

					{Mac: " NA ", Modmac: 24, Serialnum: "SAL2035URF2"},

					{Mac: " NA ", Modmac: 26, Serialnum: "SAL2035URFP"},

					{Mac: " cc-46-d6-9e-d2-e4 to cc-46-d6-9e-d2-f5  ", Modmac: 27, Serialnum: "SAL2015NQ3H"},

					{Mac: " NA ", Modmac: 29, Serialnum: "SAL2035UTLL"},
				...
				{RowModwwninfo: []struct {
					...
					{Hw: "1.1", Modwwn: 1, Slottype: "LC1", Sw: "7.0(3)I7(4)"},

					{Hw: "0.1220", Modwwn: 2, Slottype: "LC2", Sw: "7.0(3)I7(4)"},

					{Hw: "0.1110", Modwwn: 3, Slottype: "LC3", Sw: "7.0(3)I7(4)"},

					{Hw: "0.1120", Modwwn: 4, Slottype: "LC4", Sw: "7.0(3)I7(4)"},

					{Hw: "1.1", Modwwn: 22, Slottype: "FM2", Sw: "7.0(3)I7(4)"},

					{Hw: "1.1", Modwwn: 24, Slottype: "FM4", Sw: "7.0(3)I7(4)"},

					{Hw: "1.1", Modwwn: 26, Slottype: "FM6", Sw: "7.0(3)I7(4)"},

					{Hw: "1.0", Modwwn: 27, Slottype: "SUP1", Sw: "7.0(3)I7(4)"},

					{Hw: "1.6", Modwwn: 29, Slottype: "SC1", Sw: "7.0(3)I7(4)"},
